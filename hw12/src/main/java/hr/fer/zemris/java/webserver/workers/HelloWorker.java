...
/**
 * Class implements {@link IWebWorker} and represents worker which accepts string which is name, and returns
 * message which says how many letters accepted name has.
 * 
